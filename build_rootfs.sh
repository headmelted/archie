...
DEBOOTSTRAP_DIR=rootfs/debootstrap fakechroot --elfloader rootfs/lib/ld-linux-armhf.so.3 fakeroot debootstrap --second-stage --second-stage-target=rootfs --verbose;
